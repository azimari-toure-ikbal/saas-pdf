...
export default function Home() {
  return (
    <>
          ...
          <div>
            <div className="mx-auto max-w-6xl px-6 lg:px-8">
              <div className="mt-16 flow-root sm:mt-24">
                <div className="roudned-xl -m-2 bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                  <Image
      ...
      <div className="sm:mt-59 mx-auto my-32 max-w-5xl">
      ...
      <div>
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-primary py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-primary py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                It&apos;s that simple. Try out TalkPDF today - it really takes
                less than a minute.
              </span>
            </div>
          </li>
